        ...
        <PageHeader>
          <PageTitle>HIPAA Release & Informed Consent</PageTitle>
              ...
              <div style={{display:'flex',justifyContent:'end'}}>
                <Button text={'Cancel'} onClick={close} className='btn font-semibold text-btn'/>
                <Button text={'Agree'} onClick={()=>{dispacth(updateForm({termsAndConditions:true})); close()}} disabled={!form?.agreeContent || !form?.agreeTestedConsent || !(form?.agreeAssignment || !form.hasInsurance)} className='btn shadow-lg font-semibold elevated-btn'/>
              </div>
      </Content>
  </Container>
  )
